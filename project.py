...
for c in range(len(data_stream)):
    for i in range(len(data_stream)):
        previous_channels_data[c].append(data_stream[c][i: i*10])

previous_channels_data[0][1] = []
previous_channels_data[1][3] = []
previous_clean_data = [[18.5056476128486,
                18.3247015917221,
                18.594881351194,
                18.1400316807269,
                18.2756415988095,
